...
import { Users, FileText, Calendar, Activity, Plus, Settings, Crown } from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="rounded-none border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-[#f4f4f5]">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-[11px] font-bold uppercase tracking-widest text-gray-500 mb-1">Toplam İçerik</h3>
                    <p className="font-heading text-4xl font-black tracking-tighter">{team.posts?.length || 0}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="rounded-none border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  <CardContent className="p-6">
                    ...
                    <p className="font-heading text-4xl font-black tracking-tighter">{team.surveys?.length || 0}</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-6">
                  {memberSubTab === "list" ? (
                    ...
                    <>
                      <h3 className="font-heading text-xl font-extrabold uppercase tracking-tight flex items-center gap-3">
                        Bekleyen İstekler <span className="bg-accent text-white text-[10px] px-2 py-1 tracking-widest">{team.members?.filter((m: any) => m.status === "PENDING").length || 0}</span>
                      </h3>
                      <div className="flex flex-col gap-4">
                ...
                <div className="bg-gray-50 border-2 border-black p-8 h-fit shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  ...
                  <form action={handleAddMember} className="space-y-4">
                    ...
                    >
                      {isPending ? "Ekleniyor..." : "Takıma Ekle"}
                    </Button>
                  </form>
                </div>
              </div>
                  ...
                  <div className="border-2 border-accent p-5 flex items-center justify-between bg-accent/5">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-accent text-white flex items-center justify-center font-bold text-lg">
                        {team.leader.name?.[0] || "K"}
                      </div>
                      <div>
                        <p className="font-bold text-sm">{team.leader.name}</p>
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          {team.leader.department && (
                            <span className="text-[9px] text-gray-400 font-bold">{team.leader.department}</span>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {boardAddMode === "existing" ? (
                    <div className="space-y-1">
                      ...
                      {regularMembers.length === 0 && (
                        <p className="text-[10px] text-gray-400 font-medium mt-1">Atanabilecek üye bulunmuyor. Önce takıma üye ekleyin.</p>
                      )}
                    </div>
                  ) : (
                    <div className="space-y-1">
          ...
          {activeTab === "reports" && (
            <div className="animate-fade-in space-y-8">
              <div className="flex items-center justify-between mb-8">
                <h3 className="font-heading text-xl font-extrabold uppercase tracking-tight flex items-center gap-3">
                  Gelen Şikayetler <span className="bg-red-500 text-white text-[10px] px-2 py-1 tracking-widest">{team.reports?.filter((r: any) => r.status === "PENDING").length || 0} BEKLEYEN</span>
                </h3>
              </div>
            ...
            <form action={handleSurveySubmit} className="p-8 space-y-6">
              <div className="space-y-2">
                ...
                <input
                  name="question"
                  required
                  placeholder="Örn: Gelecek antrenman nerede olsun?"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  placeholder="Saha A, Saha B, Online"
