...
export default async function ProjectAdminComplaintsPage() {
  // Tüm sistemdeki şikayetleri çekiyoruz
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-32 pb-20 px-8 max-w-[1200px] mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="font-heading text-4xl font-black uppercase tracking-tighter">Sistem Genel Şikayetleri</h1>
            <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Proje Admin Paneli</p>
          </div>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-gray-50 p-4 border-l-4 border-black mb-4">
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <span className="text-[10px] font-black uppercase text-accent">Kulüp: {report.interaction.post?.club?.name || "Bireysel"}</span>
                    </div>
                  </div>
