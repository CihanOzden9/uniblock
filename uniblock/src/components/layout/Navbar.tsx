...
export default function Navbar() {
  ...
  // Simulated User Data (Will come from Auth later)
  const user = {
    firstName: "Ece",
    lastName: "Yılmaz",
          ...
          <PopoverContent className="w-80 rounded-none border-2 border-black p-0 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mr-8">
            ...
            <div className="p-0 bg-white text-black">
              <div className="p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer">
                ...
                <span className="text-[10px] text-gray-400 font-bold mt-1 block">2 SAAT ÖNCE</span>
              </div>
              <div className="p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer">
                <p className="text-[12px] font-medium leading-snug">
                  <span className="font-bold">Mühendislik Fakültesi</span> yeni bir duyuru yayınladı.
                </p>
                <span className="text-[10px] text-gray-400 font-bold mt-1 block">1 GÜN ÖNCE</span>
              </div>
            </div>
