          ...
          <div className="max-w-[1200px] mx-auto w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTeams.map((team) => {
                ...
                const boardMembers = team.members?.filter((m: any) => m.role !== "MEMBER" && m.userId !== user.id) || [];
                ...
                return (
                  <Card key={team.id} className="border-black border-2 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none bg-white overflow-hidden flex flex-col hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">
