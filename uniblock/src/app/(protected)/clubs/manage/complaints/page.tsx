    ...
    <div className="min-h-screen flex flex-col bg-surface">
      ...
      <main className="flex-1 pt-28 pb-20 px-margin-mobile md:px-margin-desktop max-w-[1200px] mx-auto w-full">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="font-heading text-3xl font-bold tracking-tight text-on-surface">Sistem Genel Şikayetleri</h1>
            <p className="text-on-surface-variant text-[13px] mt-0.5">Proje Admin Paneli</p>
          </div>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-surface-container-low p-4 rounded-lg border-l-4 border-primary mb-4">
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <span className="text-[12px] font-semibold text-accent">Kulüp: {report.interaction.post?.club?.name || "Bireysel"}</span>
                    </div>
                  </div>
